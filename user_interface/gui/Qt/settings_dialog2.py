...
tutor_program_extension_path = r'python_communication'
sys.path.append(skore_path + tutor_program_extension_path)
...
color_values = ['','','','','','']
timing_lineedit = ['time_per_tick','chord_timing_tolerance','manual_final_chord_sustain_timing']
timing_values = ['','','']
...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@Tutoring Settings@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        ...
        self.time_per_tick_label.setGeometry(QtCore.QRect(20, 470, 91, 16))
        ...
        self.chord_timing_tolerance_label.setGeometry(QtCore.QRect(20, 510, 151, 16))
        ...
        self.manual_final_chord_sustain_timing_label.setGeometry(QtCore.QRect(20, 550, 211, 16))
        ...
        self.time_per_tick_lineEdit.setGeometry(QtCore.QRect(250, 470, 241, 22))
        ...
        self.chord_timing_tolerance_lineEdit.setGeometry(QtCore.QRect(250, 510, 241, 22))
        ...
        self.manual_final_chord_sustain_timing_lineEdit.setGeometry(QtCore.QRect(250, 550, 241, 22))
